...
require 'libs.message.MiddleClass'

require 'libs.message.GraphicsStateStack'
require("libs.color")
...
Default values
--]]
MessageBottle.DEFAULT_SOUND = "libs/message/blip.ogg"
MessageBottle.DEFAULT_VOLUME = 0.5
MessageBottle.DEFAULT_BUTTON = 'space' --Button to close/select
MessageBottle.DEFAULT_INDICATOR = love.graphics.newImage('libs/message/input-indicator.png') --Image to 
...
MessageBottle.DEFAULT_FGCOLOR = {r=1,g=1,b=1}
...
MessageBottle.DEFAULT_BGCOLOR = {r=0.5,g=0.5,b=0.5}
...
function MessageBottle:drawBackground()
  ...
  local red,g,b = self.bgColor.r, self.bgColor.g, self.bgColor.b
...
function MessageBottle:setFgColor(r, g, b, a)
  local nr, ng, nb = colorConvertion(r, g, b)
  self.fgColor = {r=nr, g=ng, b=nb, a}
end
